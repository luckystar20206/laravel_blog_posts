...
@section('container')
  {{-- Main Dashboard Post --}}
    ...
    {{-- End Alert --}}
      ...
      <a href="/dashboard/categories/create" class="btn btn-success mb-5"> Create New Category</a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="/dashboard/categories/{{ $category->slug }}/edit" class="badge bg-warning" style="margin-left: 5px;">
